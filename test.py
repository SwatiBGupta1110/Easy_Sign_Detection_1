...
while True:
    ...
    hands, img = detector.findHands(img)  # To find hand in image # You want skeleton as well we will keep skeleton
    ...
    if hands:  # if there is something in hand
        ...
        # FONT_HERSHEY_COMPLEX --> Font of text, (255,0,255) color value purple, text thickness 2
